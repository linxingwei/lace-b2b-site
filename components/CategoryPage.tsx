...
export default function CategoryPage({ category }: { category: CategoryData }) {
  ...
  const faqs = isBridal ? [
    ["What bridal lace can you supply for wedding dresses and veils?", "We support embroidered bridal lace, lace appliques, 3D floral motifs, beaded and pearl embellishment, trims and custom embroidery for wedding gowns, cathedral veils, bodices, sleeves and bridal accessories."],
    ["What is the MOQ for wholesale bridal lace?", "MOQ depends on the construction. Stocked or existing designs can usually start lower than fully custom embroidery. Send the lace reference, required dimensions, quantity and application so we can confirm the practical MOQ and quotation basis."],
    ["Do you quote bridal lace per meter or per piece?", "Both are possible. Continuous lace and trim are normally quoted by length, while appliques, matched motifs and developed panels may be quoted per piece, pair or set. We confirm the unit before sampling and quotation."],
    ["Can you make custom embroidery for a cathedral veil?", "Yes. Custom veil projects can be evaluated from artwork or a reference image. We review the tulle or mesh base, embroidery width, motif scale, edge finish, veil dimensions and placement before developing a strike-off sample."],
    ["Can I approve a physical sample before bulk production?", "Yes. For custom bridal work, sample approval is recommended before bulk production so color, tulle softness, stitch definition, dimensions, drape and embellishment can be checked."],
    ["Can you ship bridal lace internationally?", "Yes. We coordinate export packing and international shipping for wholesale buyers. Share the destination country or postcode when requesting a quotation so shipping options can be reviewed."],
  ] : [
    ...
    <main>
      ...
      <section className="inner-hero">
        <div className="inner-hero-copy">
          ...
          <p>{isBridal ? "Source bridal lace from China for wedding gowns, cathedral veils and couture collections. We support embroidered lace, 3D appliques, beaded details, custom ivory tones and sample development for wholesale buyers." : category.intro}</p>
