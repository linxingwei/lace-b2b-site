...
export default function SiteHeader() {
  return (
    <>
      <div className="announcement"><span>OEM / ODM · Flexible MOQ · Worldwide delivery</span><a href="https://wa.me/message/IXEEGXESENF6F1" target="_blank" rel="noreferrer">Quotes within 24 hours <ArrowRight size={13} /></a></div>
