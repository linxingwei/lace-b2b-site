...
export default function QuoteForm() {
  ...
  return (
    <form className="quote-form" onSubmit={submit}>
      ...
      <p className={`form-note form-${status}`} aria-live="polite">{status === "sent" ? "Thank you. Your inquiry was sent to our trade team and we will review it." : status === "fallback" ? "Automatic delivery was unavailable. Continue in WhatsApp below, then tap Send to complete your inquiry." : status === "error" ? "We could not submit these details. Please review the required fields or use WhatsApp Business." : "Your details remain private. Send your requirement for review by our trade team."}</p>
