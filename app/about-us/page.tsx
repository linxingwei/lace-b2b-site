...
export const metadata = createPageMetadata("About Our Guangzhou Lace Supply Company", "Learn how Velora Lace supports global fashion buyers with Guangzhou lace sourcing, custom development, production coordination and finished-product review.", "/about-us", mediaUrl("beaded-neckline.jpg"));
...
export default function AboutPage() {
  return <main>
    <section className="page-hero"><p className="eyebrow"><span /> About Velora Lace</p><h1>A Guangzhou lace partner<br /><em>built for global buyers.</em></h1><p>Velora Lace is the international-facing brand of Guangzhou Ruiyuelai Trading Co., Ltd. We connect fashion brands, bridal designers, garment manufacturers and wholesalers with professional lace and garment accessory resources in China.</p></section>
