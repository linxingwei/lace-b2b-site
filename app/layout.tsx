...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  const organization = { "@context": "https://schema.org", "@type": "Organization", "@id": "https://www.veloracelace.com/#organization", name: "Velora Lace", legalName: "Guangzhou Ruiyuelai Trading Co., Ltd.", description: "B2B lace trim and garment accessories supplier supporting fashion brands, bridal designers and garment manufacturers.", url: "https://www.veloracelace.com", logo: "https://www.veloracelace.com/og.png", telephone: "+86 157 6795 6637", email: "1650378792@qq.com", address: { "@type": "PostalAddress", addressLocality: "Guangzhou", addressRegion: "Guangdong", addressCountry: "CN" }, areaServed: ["US", "EU", "GB", "AE", "SA"], sameAs: ["https://wa.me/message/IXEEGXESENF6F1"] };
    ...
    <html lang="en">
      <body>
        ...
        <footer className="site-footer">
          ...
          <div><h3>Get in touch</h3><a href="mailto:1650378792@qq.com">1650378792@qq.com</a><a href="https://wa.me/message/IXEEGXESENF6F1" target="_blank" rel="noreferrer">WhatsApp Business</a><span>+86 157 6795 6637</span><span>Guangzhou, China</span><small>Monday-Saturday - 9:00-18:00 CST</small></div>
